  ...
  return (
    <div className="antialiased text-white bg-black selection:bg-[#3FE56C] selection:text-black min-h-screen relative">
      ...
      <a
        ...
        className="fixed right-0 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col items-center bg-white text-black px-1.5 py-6 select-none shadow-[0_0_20px_rgba(0,0,0,0.5)] cursor-pointer transition-transform duration-300 hover:-translate-x-1 hover:shadow-green-400/40"
      >
        <span
          className="font-['Space_Grotesk'] font-bold text-[10px] uppercase tracking-[0.3em] whitespace-nowrap"
